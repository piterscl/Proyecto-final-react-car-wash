										...
										<div className="card-block">
											...
											<div className="row">
												<div className="col-sm-6">
													...
													<h6 className="text-muted f-w-400">email@gmail.com</h6>
												</div>
												<div className="col-sm-6">
													<p className="m-b-10 f-w-600">Teléfono</p>
													<h6 className="text-muted f-w-400">+569 5555 5555</h6>
												</div>
											</div>
											<h6 className="m-b-20 m-t-40 p-b-5 b-b-default f-w-600">Agendamiento</h6>
											<div className="row">
												<div className="col-sm-6">
													<p className="m-b-10 f-w-600">Servicios</p>
													<h6 className="text-muted f-w-400">Premium</h6>
												</div>
												<div className="col-sm-6">
													<p className="m-b-10 f-w-600">Fecha</p>
													<h6 className="text-muted f-w-400">05/12/2020</h6>
												</div>
											</div>
